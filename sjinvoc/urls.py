"""
URL configuration for sjinvoc project.
...
admin.site.site_title = "SJ Invoc Admin Portal"
admin.site.index_title = "Welcome to SJ Invoc Portal"

#Admin-- Panel Maanually Change txt Header End Here
